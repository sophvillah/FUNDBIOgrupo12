...
# ESCASEZ Y ALTO COSTO DE LOS BASTONES CON SENSORES DE CARGA
 <p align="center">
<img width="800" alt="image" src="https://github.com/user-attachments/assets/40d14c6e-7c38-4ceb-89e7-415f9e787e35">
</p>
...
- ### Force Cane (Intelligent Walking Cane)
    **Resumen:** Este bastón está diseñado para la rehabilitación, optimizando la función, velocidad y seguridad al caminar. Su principal función es proporcionar retroalimentación inmediata mediante sensores de presión integrados, que generan una alerta auditiva o vibratoria cuando el paciente aplica una carga incorrecta. Además, permite monitorear el progreso del paciente, enviando los datos de forma inalámbrica a una computadora para ser visualizados en tiempo real. Es fácil de usar, se adapta a distintas patologías neurológicas y ortopédicas, y cuenta con opciones inalámbricas para mayor comodidad en la rehabilitación.Además cuenta con  retroalimentación positiva, se produce en forma de vibración cuando el peso transportado por el bastón se encuentra entre los valores límite superior e inferior establecidos en la unidad de control [3].

   **Especificaciones:**
     - **Costo:** USD 899.00 (Modelo Deluxe)
     - **Dimensiones:** 120 a 150 cm
     - **Fabricante:** nCounters Engineering (Australia)
     - **Disponibilidad:** Nivel Global
     - **Facilidades:** Retroalimentación auditiva, vibratoria y visual (LED rojo), registro y representación gráfica de datos (Modelo Deluxe)
     - **Rango de detección:** Retroalimentación de carga basada en límites configurables por el terapeuta.

<p align="center">
<img width="537" alt="image" src="https://github.com/user-attachments/assets/6efa3d98-d092-4c77-b85b-f5436ccac8aa">
</p>
...
- ### Sistema de medición de cargas en bastones de antebrazo (España, 2011)
  **N° de patente:** WO2011039389A2\
  **Resumen:** Está diseñado para permitir un mejor control en el rango de fuerzas a ejercer sobre el bastón, mediante una cédula de carga y amplificador se realiza una toma de datos para enviarlos a una PC donde se analizará si se está distribuyendo eficientemente la fuerza del peso en el bastón, siendo principalmente planificado para terapias [5].

<p align="center">
  <img width="366" alt="image" src="https://github.com/user-attachments/assets/762e02d9-d68a-48bb-bcdb-78e7105cda35">
</p>

- ### Dispositivo sensor para monitorizar la marcha (España, 2022)
  **N° de patente:** ES2932738A1\
  **Resumen:** Es un dispositivo sensor diseñado para los bastones, contiene un sensor de fuerza, acelerómetro, giroscopio, y microcontrolador en una carcasa, permitiendo monitorizar el movimiento del usuario y la presión ejercida sobre el bastón [6].

<p align="center">
  <img width="521" alt="image" src="https://github.com/user-attachments/assets/ffc98956-36d6-4b52-bff0-7049ae8b9ce8">
</p>

### LISTA DE REQUERIMIENTOS 
![E](https://github.com/user-attachments/assets/39ac916b-cd16-4a7a-a007-0b81ce23bd00)
...
- [3] Ross. Force Walking Cane - Intelligently monitors gait pattern | Biofeedback. nCounters Engineering Biofeedback Rehabilitation Products. Mar 7. 2023. https://ncountersonline.com/force-cane
...
- [5] G. Chamorro Moriana, "Dispositivo sensor para monitorizar la marcha," Oficina Española de Patentes y Marcas, Patente No. ES2356959A1, 3 de marzo de 2011.
- [6] A. Rodríguez Larrad, A. Zubizarreta Pico, I. Cabanes Axpe, A. Brull Mesanza, I. Sesar Gil, J. Torres Unda, E. Portillo Pérez, A. Espín, y L. Santisteban, "Dispositivo sensor para monitorizar la marcha," Oficina Española de Patentes y Marcas, Solicitud No. ES202100703, Publicación No. ES2899440A1, 24 de enero de 2023.
